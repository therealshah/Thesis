...
public class Tddd{
	...
	private static int max_multiplier = 4; // two multipliers for min and max boundaries
	...
	*/
	...
	private static void getBlockFrequency() throws Exception{
		...
		long [] divisorArray = {333}; // run the frequency code for these divisor values (AKA expected block Size)
